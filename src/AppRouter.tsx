...
import { ClientEmailCampaignTrackingListPage } from './features/client-email-campaigns/pages/ClientEmailCampaignTrackingListPage';
import { ClientEmailCampaignTrackingDetailsPage } from './features/client-email-campaigns/pages/ClientEmailCampaignTrackingDetailsPage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/client-email-tracking" element={<Shell><ClientEmailCampaignTrackingListPage /></Shell>} />
        <Route path="/client-email-tracking/:campaignId" element={<Shell><ClientEmailCampaignTrackingDetailsPage /></Shell>} />
